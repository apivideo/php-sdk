...
[![badge](https://img.shields.io/github/stars/apivideo/php-sdk?style=social)](https://github.com/apivideo/php-sdk)
...
**This project is deprecated. It won't be updated anymore, no support will be provided, and it may not be fully compatible with the API anymore. 
Please use https://github.com/apivideo/api.video-php-client instead.**
